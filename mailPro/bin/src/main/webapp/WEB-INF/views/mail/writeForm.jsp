...
<body>
	<a href="${contextPath}/mail/writeMail">다시쓰러가자</a>
						...
						<div class="mail-main-form">
							...
							<c:choose>
								...
								<c:otherwise> <!-- 일반 메일 발송 -->
									<form action="${contextPath}/send/mail" id="mailForm" method="post" enctype="multipart/form-data">
								</c:otherwise>
							</c:choose>
						  
							<input type="hidden" name="sender" value="${mailUser.userName}">
								...
								<script>
									...
									$(function(){
										...
										for(let i in cookieStrArr){
											...
											if(cookie[0] == "${loginUser.empNo}"){ // 키값(사번)이 로그인한 사원의 사번과 동일한 경우
